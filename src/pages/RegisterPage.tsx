...
import { Building2, Mail, Phone, Receipt, Lock, AlertCircle, MapPin, Briefcase, Calculator, Calendar, CreditCard } from 'lucide-react';
          ...
          <div className="bg-white shadow-sm rounded-lg p-6 space-y-6">
            ...
            {isRetailer && (
              <div className="space-y-6 border-t pt-6">
                <h3 className="text-lg font-medium text-gray-900">Credit Assessment Information</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="mt-1 relative rounded-md shadow-sm">
                      ...
                      <input
                        {...register('panNumber', {
                          required: isRetailer ? 'PAN number is required' : false,
                          pattern: {
                    ...
                    <div className="mt-1 relative rounded-md shadow-sm">
                      ...
                      <input
                        {...register('annualTurnover', {
                          required: isRetailer ? 'Annual turnover is required' : false,
                          min: {
                            value: 100000,
                    ...
                    <div className="mt-1 relative rounded-md shadow-sm">
                      ...
                      <input
                        {...register('yearsInBusiness', {
                          required: isRetailer ? 'Years in business is required' : false,
                          min: {
                            value: 0,
                    ...
                    <div className="mt-1 relative rounded-md shadow-sm">
                      ...
                      <select
                        {...register('businessType', {
                          required: isRetailer ? 'Business type is required' : false,
                        })}
                        className="block w-full pl-10 sm:text-sm border-gray-300 rounded-md focus:ring-orange-500 focus:border-orange-500"
                      >
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-x-4">
                      <label className="inline-flex items-center">
                        <input
                          type="radio"
                          {...register('shopOwnership', {
                            required: isRetailer ? 'Shop ownership is required' : false,
                          })}
                          value="owned"
